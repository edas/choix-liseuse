var READERS = (function (window, document) {
  ...
  var default_hash = "#b&mobile=100&sedentaire=100&prix=45&ecran=100&interop=45&buttons=20&local=0&disk=0&audio=20&geek=20&resistant=0";
  ...
  var load_hash_data = function () {
    ...
    try {
      if (window.location.hash.match(/^#b&.*$/)) {
        json = unescape(window.location.hash);
      } else {
        json = default_hash;
      }
